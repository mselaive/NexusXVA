...
- **BO**: Trade Validation, Lifecycle Reporting, Trading Limits, EOD Control y Run History.
...
BO tambien tiene **Lifecycle Reporting**, que resume amendments/cancellations, aging de pendientes, promedio de review y concentracion por portfolio/simbolo. FO puede consultar su propio lifecycle report mediante API; BO ve el libro operativo completo.
...
- Cash equities y delta hedging ES: [docs/docs-ES/CashEquitiesYDeltaHedgingPlan.md](docs/docs-ES/CashEquitiesYDeltaHedgingPlan.md)
...
- FX y multi-currency.
- Cash equity lifecycle/EOD completo para P&L más fino.
